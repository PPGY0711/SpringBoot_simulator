...
public class EncodingUtil {
    ...
    public static byte[] getGB2312Bytes(String vStr) throws UnsupportedEncodingException {
        System.out.println("String ready to convert encoding:" + vStr);
        byte[] gbkArr = vStr.getBytes("gb2312");
        for(byte b:gbkArr){
